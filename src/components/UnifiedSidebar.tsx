...
const PANEL_GROUPS: PanelGroup[] = [
  {
    ...
    panels: [
      ...
      { id: 'typography', icon: <TypographyIcon />, label: 'Typographie', shortcut: '⌘⇧T' },
  ...
  },
  {
    ...
    panels: [
      ...
      { id: 'deadlines', icon: <DeadlinesIcon />, label: 'Suivi des délais', shortcut: '⌘⇧E' },
...
export function UnifiedSidebar() {
  ...
  const renderPanelContent = () => {
    switch (activePanel) {
      ...
      case 'typography':
        return <TypographyPanel onClose={closePanel} />
      case 'settings':
